...
- Before reporting work as complete, sweep the PR body for `[ ]` placeholders — every one must be `[x]` with evidence. Also sweep for `N/A` / "skipped" entries and confirm the reason is scope-of-change, not "I didn't have the tool."
